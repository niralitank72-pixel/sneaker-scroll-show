...
const KEYS: Key[] = [
  ...
  { t: 0.0, pos: [5.06, 1.265, 7.36], look: [0, 0.3429, 0], fov: 34 },
  { t: 0.1, pos: [3.565, 1.0925, 4.945], look: [0, 0.4191, 0], fov: 32 },
  // CAMERA 2 — 360 orbit
  { t: 0.17, pos: [4.6, 1.15, 1.61], look: [0, 0.4572, 0], fov: 30 },
  { t: 0.24, pos: [1.38, 1.38, -4.255], look: [0, 0.4572, 0], fov: 30 },
  { t: 0.31, pos: [-4.14, 1.15, -1.84], look: [0, 0.4572, 0], fov: 30 },
  { t: 0.38, pos: [-1.84, 1.84, 4.14], look: [0, 0.4572, 0], fov: 30 },
  // CAMERA 3 — technology inspection (close)
  { t: 0.44, pos: [2.185, 1.725, 2.99], look: [0.0762, 0.5715, 0], fov: 28 },
  { t: 0.5, pos: [1.495, 0.805, 2.99], look: [0.0762, 0.3048, 0], fov: 26 },
  { t: 0.55, pos: [-2.185, 1.15, 2.99], look: [-0.381, 0.4572, 0], fov: 28 },
  // CAMERA 4 — exploded inspection
  { t: 0.63, pos: [0.69, 1.15, 7.13], look: [0, 0.5334, 0], fov: 33 },
  { t: 0.69, pos: [3.91, 2.53, 5.29], look: [0, 0.4572, 0], fov: 32 },
  // CAMERA 5 — material macro
  { t: 0.75, pos: [1.725, 2.3, 2.415], look: [0.0762, 1.143, 0], fov: 26 },
  { t: 0.79, pos: [1.61, 0.23, 2.3], look: [0.1524, 0.0762, 0], fov: 26 },
  { t: 0.82, pos: [-2.07, -0.69, 2.53], look: [-0.2286, -0.5334, 0], fov: 28 },
  // CAMERA 6 — energy + rebuild
  { t: 0.87, pos: [0.23, 0.46, 5.29], look: [0, 0.2286, 0], fov: 32 },
  { t: 0.93, pos: [3.45, 1.61, 4.14], look: [0, 0.381, 0], fov: 32 },
  // FINAL hero — slightly below product level
  { t: 0.975, pos: [1.61, 0.368, 5.29], look: [0, 0.4191, 0], fov: 30 },
  { t: 1.0, pos: [0.1725, 0.322, 6.21], look: [0, 0.4572, 0], fov: 30 },
];
